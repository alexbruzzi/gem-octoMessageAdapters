...
#             if a_details
#               if adapters[klass].nil?
#                 adapters[klass] = []
#               end
#               adapters[klass] << a_details
#               @adapters = adapters
#             end
#           end
#         rescue Exception => e
...
#       def load_callbacks
#         begin
#           puts 'Loading Callbacks'
#           puts Octo::AdapterMethods.adapters
#           adapters.each do |ad|
#             ad.allowed_callback.each do |event|
